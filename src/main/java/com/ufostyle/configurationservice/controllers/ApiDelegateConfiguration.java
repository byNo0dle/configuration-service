...
public class ApiDelegateConfiguration implements ConfigurationApiDelegate {
  ...
  @Override
  public Mono<ResponseEntity<SetUpCs>> saveConfiguration(Mono<SetUpCs> setUpCs, ServerWebExchange exchange) {
    return setUpCs
  ...
  @Override
  public Mono<ResponseEntity<SetUpCs>> updateConfiguration(Mono<SetUpCs> setUpCs, ServerWebExchange exchange) {
    return setUpCs
  ...
  @Override
  public Mono<ResponseEntity<SetUpCs>> findByIdConfiguration(String idConfiguration, ServerWebExchange exchange) {
  ...
  @Override
  public Mono<ResponseEntity<Void>> deleteConfiguration(String idConfiguration, ServerWebExchange exchange) {
